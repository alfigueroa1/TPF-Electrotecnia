...
class MenuAllPass(tk.Frame): # heredamos de tk.Frame, padre de MenuPasaBajos
    def __init__(self, parent, controller):
        ...
        self.title = tk.Label(
            ...
            height=1,
            width=50,
            text="All-Pass Filter Parameters",
...
############ FIRST ORDER ######################
        self.titleFo = tk.Label(
            ...
            height=1,
            width=50,
            text="Critical Frequency (phase shift of 90° at this freq)",
        ...
        self.titleF1 = tk.Label(
            ...
            height=1,
            width=50,
            text="Critical Frequency 2nd Order (phase shift of 180° at this freq)",
            font=Config.SMALL_FONT,
            background="#ccffd5"
        )
