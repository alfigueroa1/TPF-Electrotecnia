...
#LOW PASS FILTER BUTTON
        ...
        self.buttonLowPass.pack( expand=0, fill=tk.NONE, pady=100)
...
#HIGH PASS FILTER BUTTON
        ...
        self.buttonHighPass.pack(expand=0, fill=tk.NONE, pady=100)
...
#ALL PASS FILTER BUTTON
        ...
        self.buttonAllPass.pack(expand=0, fill=tk.NONE, pady=100)
#ARBITRARY POLE ZERO
        ...
        self.buttonArbitraryPoleZero.pack(expand=0, fill=tk.NONE, pady=100)
